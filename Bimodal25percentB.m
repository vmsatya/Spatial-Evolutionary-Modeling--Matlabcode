...
% Generage a randomproliferation matrix for B

% Fitness: rA = 1.0 and 25% of rB=0.5 and 75% of rB=1.5
...
NumbB = 110; % 25 percent of B's will have 0.5 as the fitness rate
rB = zeros(1,441)+0.5;
rtemp = randperm(441,NumbB);
rB(rtemp)=1.5;

fid = fopen('RanProlifB-25percent-B{0.5,1.5}1.txt', 'wt');
